...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...

	{
		...
		// Hazel::Renderer2D::DrawRotatedQuad({ 1.0f,0.0f }, { 1.0f , 0.5f }, glm::radians(45.0f), {0.1f , 0.2f , 0.3f , 1.0f});
		Hazel::Renderer2D::DrawQuad({ -1.0f,0.0f }, { 0.8f , 0.8f }, { m_SqueraColor });
		Hazel::Renderer2D::DrawQuad({ 0.0f,0.0f }, { 0.5f , 0.5f }, { 0.8f , 0.2f , 0.3f , 1.0f });
